...
# Install SwiftFormat (Swift) and Prettier (Markdown).
brew install swiftformat
npm install -D prettier

update_or_create_file "init-ios" ".gitignore"
update_or_create_file "init-ios" ".prettierignore"
update_or_create_file "init-ios" ".prettierrc"
update_or_create_file "init-ios" ".swiftformat"
update_or_create_file "init-ios" "AGENTS.md"
update_or_create_file "init-ios" "CLAUDE.md"
update_or_create_file "init-ios" "DESIGN.md"
update_or_create_file "init-ios" "GEMINI.md"

git add .
git commit -m $'chore: standard initial setup\n\n```bash\nbash <(curl -s https://raw.githubusercontent.com/walkccc/snippets/main/init-ios.sh)\n```'
